const button = document.getElementById('formModificar:button1');
const formulario = document.getElementById('formModificar');
formulario.addEventListener('click', function(e){
    //Leer del formulario de gastos
    const idRepuesto = document.getElementById('formModificar:idRepuesto').value;
    const nombre= document.getElementById('formModificar:nombre').value;
    const proveedor = document.getElementById('formModificar:proveedor').value;
    const marcaRepuesto = document.getElementById('formModificar:marcaRepuesto').value;
    const costo = document.getElementById('formModificar:costo').value;
    const precioVenta = document.getElementById('formModificar:precioVenta').value;
    const cantidad = document.getElementById('formModificar:cantidad').value;
    const fechaAdquisicion = document.getElementById('formModificar:fechaAdquisicion').value;
    console.log('HOLA');
